...
| --- | --- | --- | --- | --- |
| 01 | [hello-gemini](https://github.com/TheRavi/spring-ai-recipes/blob/main/01-hello-gemini) | Google Gemini (free) | First Spring AI call to Gemini's API, no credit card needed | [Spring AI + Gemini: A First API Call in Java](https://ravibuilds.dev/blog/spring-ai-gemini-first-api-call) |
| 02 | [structured-output](https://github.com/TheRavi/spring-ai-recipes/blob/main/02-structured-output) | Google Gemini (free) | Returning typed Java records from an LLM with `.entity()` | [Spring AI Structured Output: Typed Java Records from Gemini in One Line](https://ravibuilds.dev/blog/spring-ai-structured-output-gemini) |
| 03 | [tool-calling](https://github.com/TheRavi/spring-ai-recipes/blob/main/03-tool-calling) | Google Gemini (free) | Letting the LLM invoke your Java methods, backed by a real database | [Spring AI Tool Calling: Let Gemini Query Your Database in Java](https://ravibuilds.dev/blog/spring-ai-tool-calling-gemini) |
| 04 | [provider-portability](https://github.com/TheRavi/spring-ai-recipes/blob/main/04-provider-portability) | Gemini + OpenRouter | Same code, two providers, and where the abstraction leaks | [Spring AI Provider Portability: Running One App on Gemini and OpenRouter](https://ravibuilds.dev/blog/spring-ai-provider-portability) |
| 05 | rag-basics | *Coming soon* | Retrieval-augmented generation in Spring AI | *Coming soon* |
...
> **Don't hardcode API keys in `application.yml`.** Use environment variables or a gitignored `.env` file. Each recipe ships with a `.env.example` template.
...
| --- | --- | --- |
| Google Gemini | ✅ 1,500 req/day, no credit card | [01](https://github.com/TheRavi/spring-ai-recipes/blob/main/01-hello-gemini), [02](https://github.com/TheRavi/spring-ai-recipes/blob/main/02-structured-output), [03](https://github.com/TheRavi/spring-ai-recipes/blob/main/03-tool-calling), [04](https://github.com/TheRavi/spring-ai-recipes/blob/main/04-provider-portability) |
| OpenRouter | ✅ Free models available, one key for hundreds of models | [04](https://github.com/TheRavi/spring-ai-recipes/blob/main/04-provider-portability) |
